...
# monthly payment to pay off the balance within one year using bisection method. 
...
lower_bound = outstanding / 12.0
upper_bound = (outstanding * (1 + (annual_rate / 12.0)) ** 12.0) / 12.0
min_payment = lower_bound
